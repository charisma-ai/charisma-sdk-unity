...
namespace CharismaSDK
{
    ...
    public class Playthrough
    {
        ...
        /// <summary>
        /// Called when a new message has been received from Charisma.
        /// </summary>
        ...
        public async void Connect(Action onReadyCallback)
        {
            ...
            room.OnMessage<object>("speech-recognition-result", (message) =>
            {
            ...
            room.OnMessage<object>("speech-recognition-error", (message) =>
            {
                Logger.LogWarning($"Received `speech-recognition-error` event: {JsonConvert.SerializeObject(message)}");
            });
        }
