...
{   
    ...
    public class Response
    {
        ...
        /// </summary>
        [JsonConstructor]
        public Response(int conversationId, CharismaMessageType messageType, Message message, bool endStory, bool tapToContinue, CharacterMood[] characterMoods, Memory[] memories)
        {
